...
if($i !== 3) $r .= '<link rel="dns-prefetch" href="http://xn--81h.cf/">';
if($i !== 2) $r .= '<link rel="dns-prefetch" href="http://xn--71h.cf/">';
if($i !== 1) $r .= '<link rel="dns-prefetch" href="http://xn--91h.cf/">';
if($i !== 0) $r .= '<link rel="dns-prefetch" href="http://xn--61h.cf/">';
...
$r .= '<meta property="og:image" content="http://' . LOCAL . 'xn--61h.cf/image.jpg">';
...
$r .= '<link rel="apple-touch-icon-precomposed" href="http://' . LOCAL . 'xn--61h.cf/apple-touch-icon-precomposed.png">';
...
$r .= '</style>';
$r .= '<script src="http://' . LOCAL . 'xn--61h.cf/script.js"></script>';
$r .= '</head>';
$r .= '<body>';
